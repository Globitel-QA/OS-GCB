...
MochiKit.Base.update(MochiKit.Color.Color, {
    ...
    fromName: function (name) {
        ...
        var htStandardTemplateolor = Color._namedColors[name.toLowerCase()];
        if (typeof(htStandardTemplateolor) == 'string') {
            return Color.fromHexString(htStandardTemplateolor);
