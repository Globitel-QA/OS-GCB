...
<body>
				...
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-social-dribbble font-green"></i> <span
							class="caption-subject font-green bold" id="Agent_AddAgent">Add Agent</span>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<form role="form">
								...
								<div class="form-group">
									<label id="Users_PhoneNumber">Phone Number</label> 
									<input class="form-control input-sm number" id="txtPhone" maxlength="20">
	...
	<script>
		...
		function IsFormComplete() {
			...
			} else if (Module_CheckExistanceWithOutParameters('txtName' , BackendServiceIPAddress+'/api/agent/GetByName/' + encodeURIComponent($("#txtName").val().trim()) 
			...
			} else if (Module_CheckExistanceWithOutParameters('txtPhone' , BackendServiceIPAddress+'/api/agent/CheckByPhone/' +  encodeURIComponent($("#txtPhone").val().trim()) 
			...
			} else if (Module_CheckExistanceWithOutParameters('txtEmail' , BackendServiceIPAddress+'/api/agent/CheckByEmail/' +  encodeURIComponent($("#txtEmail").val().trim()) 
			...
			$.ajax({
				...
				success : function(data) {
					if (CheckResponse(data)) {	
						loadpage('Interfaces/Agent/Agent.jsp?AddNewPage=1',
								'SystemSettings');
					} else {
						loadpage('Interfaces/Agent/Agent.jsp?AddNewPage=-1',
								'SystemSettings');
